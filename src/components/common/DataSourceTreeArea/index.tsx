...
function forEachNode(nodes: TreeNodeInfo[] | undefined, callback: (node: TreeNodeInfo) => void) {
    ...
    nodes.forEach((node: TreeNodeInfo) => {
        callback(node)
...
const INITIAL_STATE: TreeNodeInfo[] = [
    {
        ...
        hasCaret: true,
        icon: 'folder-close',
        label: <div>Folder 0</div>,
    },
    {
        id: 1,
        icon: 'folder-close',
        isExpanded: true,
        label: <div>Hello there!</div>,
        childNodes: [
            {
                id: 2,
                icon: 'document',
